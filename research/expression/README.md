...
The next pressure is **scope rather than optimization**: repeat frozen interventions across more pristine artifacts and observer classes, add human evidence only when making a human-response claim, test encounter/time/medium drift separately, and audit whether the independently evolved Finance and Studio search ledgers now justify a shared Harness/Runtime primitive.
